  ...
  return (
    <div className='container-fluid'>
      <div className='row p-5 mb-5' >
        <h1 className="hero-title text-4xl  text-center m-9">We pioneered the discount broking model in India.<br />
          Now, we are breaking ground with our technology.</h1>

      </div>
      <div className='row p-5 mb-5 border-top mx-56 flex mt-24' >
        <div className='  w-1/2 pr-5 text-xl '>
        ...
        <div className='w-1/2 pl-4  text-xl'>
